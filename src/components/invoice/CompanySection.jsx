    ...
    <Card>
      ...
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-[6rem_minmax(0,1fr)] sm:items-stretch">
          <div className="flex min-w-0 flex-col gap-2 sm:h-full sm:min-h-0">
            <input
              ref={fileInputRef}
              type="file"
              accept="image/*"
            ...
            <div className="relative flex min-h-24 flex-1 flex-col sm:min-h-0">
              ...
              >
                {logoDataUrl ? (
                  ...
                  <span className="w-full min-w-0 max-w-full whitespace-normal px-2">
                    Add your logo
                  </span>
                )}
              </button>
