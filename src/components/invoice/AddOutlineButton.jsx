...
export function AddOutlineButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={clsx(
        'sleek-inline-action sleek-ds-btn sleek-ds-btn--outline inline-flex self-start cursor-pointer flex-row flex-nowrap items-center gap-1.5 px-4 py-3 text-sm',
        className,
      )}
      {...rest}
    >
